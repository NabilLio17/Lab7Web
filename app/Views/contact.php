...
<div class="contact-container">
    <div class="contact-info">
        <p><strong><i class="fas fa-envelope"></i> Email:</strong>
            <a href="mailto:taufikhidayat3621@gmail.com">nabilsawares@gmail.com</a>
        </p>
        <p><strong><i class="fas fa-map-marker-alt"></i> Alamat:</strong> Tambelang, Bekasi</p>
        <p><strong><i class="fas fa-phone"></i> Telepon:</strong>
            <a href="tel:+6281286275726">+62 895 3885 80040</a>
        </p>
    </div>
